...
import com.mycontainer.ex03.ServletProcessor;
import com.mycontainer.ex03.StaticResourceProcessor;
...
public class HttpProcessor {
	...
	public void process(Socket socket) {
		...
		try {
			...
			// check if this is a request for a servlet or a staic resource
	...
	private void parseRequest(SocketInputStream input, OutputStream output) throws IOException, ServletException {
		...
		// Set the corresponding request proerties
